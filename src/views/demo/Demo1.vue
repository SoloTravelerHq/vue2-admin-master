  ...
  data () {
    return {
      columns: [
        ...
        { field: "name", label: "姓名", fixed: "left", action: this.detail },
        { field: "sex", label: "性别", setTextClass: this.setSexTextClass },
        { field: "age", label: "年龄", sortable: true },
        { field: "grade", label: "年级" },
        { field: "class", label: "班级" },
        { field: "xxx", label: "家长" },
        { field: "xphone", label: "联系电话" },
        { type: "customHeader", field: "yyy", label: "班主任", sortable: true, action: this.yyyDetail },
        { field: "yphone", label: "联系电话" },
        {
          type: "operate",
          fixed: "right",
          btns: [
